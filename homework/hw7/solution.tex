...
\Q{Blind signal detection}
  ...
  \newpage
  \Q{Minimum energy required to steer the state to zero}
  \begin{solution}
    TODO
  \end{solution}
  ...
  \begin{solution}
    \begin{enumerate}[label=(\alph*)]
      \item The minimum number of sensors required for such an observer is $3$.
      \item
        The minimum degree observer is $j = 1$.
    \end{enumerate}
  \end{solution}
